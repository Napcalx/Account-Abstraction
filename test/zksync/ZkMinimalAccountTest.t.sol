...
contract ZkMinimalAccountTest is Test {
    ...
    uint256 constant NEW_AMOUNT = 1e18;
    ...
    function setUp() public {
        ...
        usdc = new ERC20Mock();
        vm.deal(address(minimalAccount), NEW_AMOUNT);
    }
    ...
    function _signTransaction(
        ...
        bytes32 unsignedTranscationHash = MemoryTransactionHelper.encodeHash(
            transaction
        );
        uint8 v;
        bytes32 r;
        ...
        (v, r, s) = vm.sign(ANVIL_DEFAULT_KEY, unsignedTranscationHash);
    ...
    function _createUnsignedTransaction(
        ...
        return
            Transaction({
                ...
                maxFeePerGas: 1677216,
                maxPriorityFeePerGas: 1677216,
                paymaster: 0,
                nonce: nonce,
                value: value,
